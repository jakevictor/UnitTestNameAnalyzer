...
{
    [TestFixture]
    public class MethodNameIsTwoOrThreePartsRuleTests
    {
        private MethodNameIsTwoOrThreePartsRule sut;

        [SetUp]
        public void SetUp() =>
            sut = new MethodNameIsTwoOrThreePartsRule();

        [Test]
        public void Enforce_WhenMethodNameHasOnlyOnePart_ReportsWarningDiagnostic()
        {
            // Arrange
            ...
            Assert.That(diagnostic.GetMessage(), Is.EqualTo("Unit test name 'Foo' is not two or three parts separated by an underscore."));
        ...
        [Test]
        public void Enforce_WhenMethodNameHasThreeParts_DoesNotReportDiagnostic()
        {
            // Arrange
        ...
        [Test]
        public void Enforce_WhenMethodNameHasFourParts_ReportsWarningDiagnostic()
        {
            // Arrange
            ...
            var diagnostic = reportedDiagnostics.Single();
            Assert.That(diagnostic.Severity, Is.EqualTo(DiagnosticSeverity.Warning));
            Assert.That(diagnostic.GetMessage(), Is.EqualTo("Unit test name 'Foo_Foo_Foo_Foo' is not two or three parts separated by an underscore."));
